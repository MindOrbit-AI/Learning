...
- visualWorkspace.kind one of: "part_model" (equal parts — shade/count), "number_line", "timeline", "node_link", "slot_fill" (drag items into ordered array slots inside visual_problem).
