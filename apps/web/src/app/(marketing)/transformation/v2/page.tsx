...
export const metadata: Metadata = {
  ...
  description:
    "MindOrbit turns scattered studying into a clear learning path with diagnostics, mastery maps, and interactive puzzles that train the right gaps.",
  openGraph: {
    title: "MindOrbit - From hidden gaps to visible progress",
    description:
      "Move from guessing what is wrong to knowing exactly what to fix next, then train it through interactive puzzles.",
    url: "/transformation",
...
const AFTER_POINTS = [
  ...
  "Puzzles and missions built around weak spots, not busywork",
...
const LOOP = [
  {
    ...
    body: "Find the hidden nodes that make a subject feel harder than it should.",
  },
  {
    step: "02",
  ...
  {
    step: "03",
    title: "Play targeted puzzles",
    body: "Use the puzzle arcade to make weak concepts visible, hands-on, and repeatable.",
  },
  {
    step: "04",
...
const PUZZLE_FEATURES = [
  {
    title: "Hundreds of STEM puzzles",
    body: "Math, science, technology, and engineering challenges give students more ways to practice the same underlying skill.",
    Icon: Grid3X3,
  },
  {
    title: "Multiple interaction types",
    body: "Students drag, sort, match, trace paths, use sliders, enter numbers, and build visual models instead of passively watching.",
    Icon: Gamepad2,
  },
  {
    title: "A path from play to mastery",
    body: "XP, streaks, filters, and unlocks keep practice moving while MindOrbit keeps the work pointed at real learning gaps.",
    Icon: Layers3,
  },
] as const;
            ...
            <div className="grid items-center gap-12 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:gap-14">
              <ScrollReveal className="min-w-0">
                ...
                <p className="mt-6 max-w-2xl text-lg font-semibold leading-relaxed text-muted-foreground sm:text-xl">
                  MindOrbit finds what a student is missing, turns it into a clear learning map, then lets them
                  train the right skills through interactive STEM puzzles.
                </p>
                <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:items-center">
                  <DuoPrimaryLink href="/puzzles">
                    Play puzzles
                ...
                <p className="mt-5 max-w-xl text-sm font-semibold leading-relaxed text-muted-foreground">
                  The promise is simple: stop guessing what is wrong, know what to fix next, then practice it
                  until it sticks.
                </p>
              </ScrollReveal>
            ...
            <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
              <ScrollReveal>
                <p className="text-xs font-extrabold uppercase tracking-[0.2em] text-primary">
                  Included: the puzzles page
                </p>
                <h2 className="mt-4 text-3xl font-extrabold tracking-tight sm:text-4xl">
                  The transformation becomes playable.
                </h2>
                <p className="mt-5 text-lg font-semibold leading-relaxed text-muted-foreground">
                  The diagnostic tells students what to fix. The puzzles page gives them a low-friction way to
                  train those skills across math, science, technology, and engineering.
                </p>
                <div className="mt-8 flex flex-col gap-4 sm:flex-row">
                  <Link
                    href="/puzzles"
                    className="inline-flex h-14 items-center justify-center gap-2 rounded-2xl border-b-[4px] border-[#0d6ebd] bg-[hsl(var(--duo-blue))] px-8 text-sm font-extrabold uppercase tracking-wide text-white shadow-sm transition hover:brightness-105 active:translate-y-px active:border-b-[3px] sm:text-base"
                  >
                    Open puzzle arcade
                  ...
                  <Link
                    href="/try-diagnostic"
                    className="inline-flex h-14 items-center justify-center rounded-2xl border-[3px] border-primary bg-background px-8 text-sm font-extrabold uppercase tracking-wide text-primary shadow-sm transition hover:bg-primary/10 sm:text-base"
                  >
                    Find gaps first
                  </Link>
                </div>
              ...
              <ScrollReveal delay={0.08}>
                <div className="overflow-hidden rounded-[2rem] border-2 border-border bg-card shadow-[0_14px_0_0_rgba(0,0,0,0.05)]">
                  <div className="bg-gradient-to-br from-[#ddf4ff] via-background to-primary/10 p-6">
                    <div className="flex items-center justify-between gap-4">
                      <div>
                        <p className="text-xs font-extrabold uppercase tracking-[0.2em] text-[hsl(var(--duo-blue))]">
                          MindOrbit Arcade
                        </p>
                    ...
                    <div className="mt-6 grid grid-cols-2 gap-3 sm:grid-cols-3">
                      {PUZZLE_EXAMPLES.map((puzzle) => (
                        <div
                          key={puzzle}
                          className="rounded-2xl border border-border/80 bg-background/85 px-3 py-3 text-center text-xs font-extrabold text-foreground"
                        >
                          {puzzle}
                        </div>
                      ))}
                  ...
                  <div className="grid gap-4 p-6 sm:grid-cols-3">
                    <div className="rounded-2xl bg-secondary/70 p-4 text-center">
                      <p className="text-2xl font-extrabold text-foreground">STEM</p>
                    ...
                    <div className="rounded-2xl bg-secondary/70 p-4 text-center">
                      <p className="text-2xl font-extrabold text-foreground">Daily</p>
                      <p className="mt-1 text-xs font-bold uppercase tracking-wide text-muted-foreground">
                        Practice
                      </p>
                    </div>
        ...
        <section className="border-b border-border/60 py-16 sm:py-20">
          <div className="container mx-auto px-4">
            <ScrollReveal className="mx-auto max-w-3xl text-center">
              ...
              <h2 className="mt-4 text-3xl font-extrabold tracking-tight sm:text-4xl">
                They make the invisible parts of learning concrete.
              </h2>
            </ScrollReveal>

            <div className="mx-auto mt-12 grid max-w-5xl gap-6 sm:grid-cols-3">
              {PUZZLE_FEATURES.map(({ title, body, Icon }, index) => (
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="mx-auto mt-12 grid max-w-5xl gap-6 sm:grid-cols-3">
              {OUTCOMES.map(({ title, body, Icon }, index) => (
                <ScrollReveal key={title} delay={index * 0.06}>
                  <div className="h-full rounded-3xl border-2 border-border bg-card p-6 text-center shadow-[0_8px_0_0_rgba(0,0,0,0.06)]">
                    <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-[hsl(var(--duo-blue)_/_0.15)] text-[hsl(var(--duo-blue))]">
                      <Icon className="h-8 w-8" strokeWidth={2.25} />
                    </div>
                    <h3 className="mt-5 text-lg font-extrabold text-foreground">{title}</h3>
                    <p className="mt-2 text-sm font-semibold leading-relaxed text-muted-foreground">
          ...
          <div className="container mx-auto px-4">
            <ScrollReveal className="mx-auto max-w-4xl rounded-[2rem] border-2 border-border bg-card p-8 text-center shadow-[0_14px_0_0_rgba(0,0,0,0.05)] sm:p-12">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-lg font-semibold leading-relaxed text-muted-foreground">
                Start with one diagnostic, then jump into puzzles that make practice feel lighter while keeping
                progress real.
              </p>
